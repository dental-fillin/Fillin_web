...
/*
  DentalJobsClient: Client component providing filtering & rendering styled job cards.
  Cloned from JobsClient.jsx and adapted for dental-careers page.
*/
export default function DentalJobsClient({ jobs }) {
  ...
  return (
    <>
      {/* Filter Section */}
      <section className="py-8 bg-white rounded-lg border-2 border-[#2C2E9F] mb-6">

            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-[#2C2E9F] rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@dentalaid.co.nz</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Greater Auckland Region<br />
                    From Orewa to Pukekohe</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="bg-[#2C2E9F] rounded-xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Why Choose Fillin?</h3>

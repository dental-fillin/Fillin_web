        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Established in 2016, Fillin provides comprehensive dental staffing solutions including recruitment, temping services, staff training, and equipment maintenance across the greater Auckland region.
            </p>

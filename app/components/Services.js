  ...
  const services = [
    {
      ...
      description: 'Fillin employs and provides temporary hygienists, oral health therapists, dental assistants, receptionists, and dentists. We service the greater Auckland region, from Orewa in the north, down to Pukekohe in the south, and from the east coast to the west coast of Auckland.',
      icon: (
    ...
    },
    {
      ...
      title: 'Dental Equipment Services',
      description: 'We currently provide electrical safety testing for dental and medical equipment, along with some minor repairs and maintenance work. We will also be expanding soon to include all repairs and service work for dental equipment. Keep an eye out for more updates soon on our website.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {services.map((service) => (
            <div key={service.id} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <button className="text-[#2C2E9F] font-semibold hover:text-[#1a1c6b] transition-colors">
                Read more →
              </button>
            </div>
          ))}
